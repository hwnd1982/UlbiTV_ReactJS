...
function Posts() {
  const
    ...
    [limit, setLimit] = useState(+localStorage.getItem('pagesLimit') || 10),
    [page, setPage] = useState(+localStorage.getItem('currentPage') || 1),
  ...
  return (
    <div className="App">
      ...
      <PostFilter filter={filter} setFilter={setFilter} >
        <Counter value={limit} setLimit={setLimit} />
      </PostFilter>
